...
export const projects: Project[] = [
  ...
  { id: 'yn-2', name: '云南瑞丽懿诚娱乐', category: 'bar', region: '瑞丽', province: '云南', imageUrl: BAR_IMAGES[1], videoUrl: 'https://cdn.pixabay.com/video/2021/09/06/87588-601614761_medium.mp4' },
  { id: 'yn-3', name: '云南昭通亿瓦酒吧', category: 'bar', region: '昭通', province: '云南', imageUrl: BAR_IMAGES[2] },
  { id: 'yn-4', name: '云南瑞丽约克王朝', category: 'bar', region: '瑞丽', province: '云南', imageUrl: BAR_IMAGES[3] },
  { id: 'yn-5', name: '云南腾冲 叶 live house', category: 'bar', region: '腾冲', province: '云南', imageUrl: BAR_IMAGES[0] },
  { id: 'yn-6', name: '云南嵩明7M酒吧', category: 'bar', region: '嵩明', province: '云南', imageUrl: BAR_IMAGES[1] },
  { id: 'yn-7', name: '云南镇雄985club', category: 'bar', region: '镇雄', province: '云南', imageUrl: BAR_IMAGES[2] },
  { id: 'yn-8', name: '云南丽江红馆酒吧', category: 'bar', region: '丽江', province: '云南', imageUrl: BAR_IMAGES[3] },
  { id: 'yn-9', name: '云南会泽将进酒电音剧场', category: 'bar', region: '会泽', province: '云南', imageUrl: BAR_IMAGES[0] },
  { id: 'yn-10', name: '云南昆明南live house', category: 'bar', region: '昆明', province: '云南', imageUrl: BAR_IMAGES[1] },
